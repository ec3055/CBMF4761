...
print("input_adj_file:",base_dir+"/Adjacency_matrix/{}.txt".format(sample_type))


# EXPANDING ADJACENCY MATRIX #
df_ = expand_adj_matrix.expand_adj_matrix(input_adj_file)

# # Read adjacency matrix
# df_ = pd.read_csv(input_adj_file, sep="\t",index_col=0)
print("adjacency matrix len:",len(df_))
df = df_.values
