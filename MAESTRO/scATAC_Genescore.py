...
def genescore(fileformat, directory, outprefix, peakcount, feature, barcode, genedistance, species, model = "Enhanced"):
    ...
    annotation_path = "/content/drive/MyDrive/deeptfni/MAESTRO/annotations"
...
def main():
    parser = ap.ArgumentParser(description="Calculate gene score according to scATAC peak count.")
    subparsers = parser.add_subparsers(dest="command")

    genescore_parser(subparsers)  # Add subparser for the 'scatac-genescore' command

    args = parser.parse_args()
    if args.command == "scatac-genescore":
        genescore(args.format, args.directory, args.outprefix, args.peakcount, args.feature,
                  args.barcode, args.genedistance, args.species, args.model)
