...
print("input file:",input_dir_file)
tmp = pd.read_csv(input_dir_file, sep=',', index_col=0)
data = tmp.values
print("data shape:",len(tmp))
...
input_directory = "/content/drive/MyDrive/deeptfni/"
...
mtx_file_dir = "/content/drive/MyDrive/deeptfni/" + sample_type + "/mtx_file"
...
# output_directory = "./" + sample_type + "/"  	#arg[3]
output_directory = args.output_directory
print("output dir for mtx_2_h5:",output_directory)
outprefix = "8_" + sample_type

mtx_2_h5(directory=output_directory, outprefix=outprefix, matrix_file=matrix_file, feature_file=feature_file,
         barcode_file=barcode_file, gene_column=2, genome='GRCh38',
         datatype='Peak')
